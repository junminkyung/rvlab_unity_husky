...
public class HuskyDrive : Agent
{
    ...
    private void ResetArticulationBody()
    {
        ...
        rBody.TeleportRoot(new Vector3(-6.7f, 1.5f, 6.7f), Quaternion.Euler(0f, 90f, 0f));
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers) 
    {
        ...
        float distanceToWallE = Vector3.Distance(rBody.transform.localPosition, WallE.localPosition);
        float distanceToWallN = Vector3.Distance(rBody.transform.localPosition, WallN.localPosition);
        float distanceToWallS = Vector3.Distance(rBody.transform.localPosition, WallS.localPosition);
        float distanceToWallW = Vector3.Distance(rBody.transform.localPosition, WallW.localPosition);
